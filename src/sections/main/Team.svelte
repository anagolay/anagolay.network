...
<Section class="flex pt-20 text-center">
	<div
		id="team"
		class="relative p-5 bg-gradient-to-b from-anagolayWhite/10 to-transparent w-full teamGrid backdrop-blur-md rounded-lg md:rounded-3xl md:mx-auto md:py-6 shadow-card shadow-teal-300"
	>
