...
<Section class="flex pt-20 text-center">
	<div class="w-full md:container">
		<div
			id="team"
			class="w-full lg:w-fit p-5 bg-gradient-to-b from-anagolayWhite/10 to-transparent rounded-lg md:rounded-3xl md:mx-auto md:py-6 shadow-card shadow-teal-300"
		>
			<div class="w-80 max-w-full mx-auto sm:w-full">
				...
				<div class="sm:w-5/6 sm:mx-auto h-72 sm:h-48 lg:h-32">
				...
				<div class="flex items-center w-full justify-center">
					{#each selected.links as link, i}
						<a
							...
							target="_blank"
							rel="noreferrer"
							class="flex justify-center items-center shadow-button w-10 h-10 sm:w-16 sm:h-16 active:shadow-pressed mx-3 md:mt-5 bg-darkblue rounded-full"
						>
