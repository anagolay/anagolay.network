<div class="flex flex-col md:block pt-44 md:pt-32 pb-28 md:pb-0">
	<div
	...
	/>
	<div class="relative">
		<h1 class="tracking-wider text-center font-extrabold text-3xl md:text-5xl md:text-left">
			<p class="md:leading-[4rem]">How does it work?</p>
		</h1>

		<h2
			class="w-full text-center md:w-2/3 lg:w-3/5 xl:w-1/2 mt-8 text-base md:text-lg lg:text-2xl md:text-left"
		>
			<p class="">
	...
	<div class="hidden md:block -mt-[24rem] lg:-mt-[28rem] xl:-mt-[30rem] 2xl:-mt-[33rem] -mx-8 mb-20">
