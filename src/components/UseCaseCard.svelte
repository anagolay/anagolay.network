...
>
	{#if isInView}
		<div in:fade={{ duration: 500, delay: (i % 3) * 300 }} class="flex-col h-100 mt-20">
			<div
				class="shadow-card shadow-teal-300 flex flex-col bg-anagolayBlack bg-gradient-to-b from-anagolayWhite/5 to-transparent rounded-lg pb-3 px-3 2xl:px-6 text-center md:mx-2 md:w-72 2xl:w-80 h-[25rem]"
			>
				...
				<p class="w-full text-green text-center h-16 2xl:h-20 2xl:pt-2">
					{data.title}
				</p>
