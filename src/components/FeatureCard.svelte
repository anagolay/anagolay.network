...
>
	{#if isInView}
		<div
			...
			class="w-[22rem] 2xl:w-[26rem] bg-gradient-to-b from-anagolayWhite/5 to-transparent featureCard border border-darkblue max-w-full md:max-w-none my-8 mx-auto flex flex-col items-center rounded-3xl h-48 px-12 mt-8 text-base xl:text-xl"
		>
			<div
